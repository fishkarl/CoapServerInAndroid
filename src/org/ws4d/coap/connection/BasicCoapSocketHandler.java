...
public class BasicCoapSocketHandler implements CoapSocketHandler {
    ...
    protected class WorkerThread extends Thread {
		...
		@Override
		public void run() {
		    Log.i("BasicCoapSocketHandler", "Receive Thread started.");
			...
			while (dgramChannel != null) {
				...
				if (addr != null){
					Log.i("BasicCoapSocketHandler", "handle incomming msg");
		...
		private void sendUdpMsg(CoapMessage msg) {
		    ...
		    try {
		        ...
		        Log.i("BasicCoapSocketHandler", "Send Msg with ID: " + msg.getMessageID());
		    } catch (IOException e) {
		    	e.printStackTrace();
